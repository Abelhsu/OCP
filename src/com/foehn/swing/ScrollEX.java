...
public class ScrollEX extends JFrame {
    ...
    private JLabel lbImage = new JLabel(new ImageIcon("res\\butterfly.jpg"));
    //顯示圖片的畫布

    JLabel lbHor = new JLabel("欄標頭", JLabel.CENTER),
    ...
    JScrollBar sbHor = spImage.getHorizontalScrollBar(), sbVer = spImage.getVerticalScrollBar();
    //取得捲軸面版的捲軸列
